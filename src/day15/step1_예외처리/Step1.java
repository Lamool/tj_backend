...
public class Step1 {
    public static void main(String[] args) {
        ...
        // [1] 일반 예외 : 발생 할 수도 있고 안 할 수도 있고, 컴파일러 무조건 예외처리 검사
        try {
            // ======== 예외가 발생 할 것 같은 ======== //
        ...
        int result1 = Integer.parseInt(str3);     // Integer클래스 : int형 관련 클래스, .parseInt() 문자열 --> 정수형 타입 변환
                                    // .parseInt() : static 함수 인가요? 맞아요.     // 객체 없이 클래스를 사용하고 있음. 들어가면 static 써있음. static 함수는 객체 없이 사용하는 애
        System.out.println(result1);

        try {
            int result2 = Integer.parseInt(str4);
            System.out.println(result2);
            // java.lang.NumberFormatException: For input string: "1aa"
