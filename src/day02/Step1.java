...
public class Step1 {        // class s // 자바는 모든 코드를 클래스 안에 작성한다.
    ...
    // main + 엔터 : main 함수  // 실행할 코드는 모두 main 함수(스레드 포함(코드를 읽어주는 역할이 스레드다?)) 안에 작성한다.
    // 지역변수 정의, 함수 호출만 가능(함수 정의는 안 됨)
    public static void main(String[] args) {        // main s
       ...
       // 코드 실행 : 1. ctrl + shift + f10,    2. main 함수 왼쪽에 초록색 실행 화살표 클릭
        ...
        char c1 = 'a';      // 'a' 상수 풀에 이미 존재하는 'a' (리터럴)를 char c1 변수에 복사/대입
            // 'a' 값  a값이 살고 있는 주소
            // 'a'    부평구 20-12번지
            // c1에는 부평구 20-12번지 저장된 상태
        char c2 = 'a';
            // c2에는 부평구 20-12번지 저장된 상태

        // 리터럴이란 ? 개발자 코드에 입력하는 모든 숫자, 문자, 논리값들을 일컫는 말 (문자열 제외)
