...
public class Step3 {    // class s
    public static void main(String[] args) {    // main s
        ...
        // x = 10
        // 세미콜론 기준으로 증감된다? x++면 끝나고 증가
        System.out.println(x++);    // 10, 출력 후에 증가
        System.out.println(x);      // 11
        System.out.println(++x);    // 12, 출력 전에 증가

        System.out.println(x--);    // 12, 출력 후에 감소
        System.out.println(x);      // 11
        System.out.println(--x);    // 10, 출력 전에 감소
