...
public class Step2 {
    ...
    public static void main(String[] args) {
        ...
        longValue = 100;
        float floatValue = longValue;   // long(8바이트) --> float(4바이트) : 묵시적 형 변환 (부동소수점의 표현 단위 더 크기 때문에 가능, 더 정밀하게 때문에)
        ...
        byte b1 = 10;
        byte b2 = 20;
        int result1 = b1 + b2;      // byte + byte = . int, reslut1 자료형은 int이다
        ...
        int i1 = 10;
        double d1 = 4.0;            // int + double => double
