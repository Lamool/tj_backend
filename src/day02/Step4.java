...
public class Step4 {    // class s
    public static void main(String[] args) {    // main s
                    ...
                    // printf("형식문자", 리터럴 또는 변수명)                             : 출력 함수 + 형식문자 지원
                        ...
                        /*
                            ...
                            %d : 정수      %f : 실수
                                ...
                                %-자리수d : 자릿수만큼 자릿수를 차지, 만일 비어있으면 공백처리, 왼쪽 정렬
                                %0자릿수d : 자릿수만큼 자릿수를 차지, 만일 비어있으면 '0'처리, 오른쪽 정렬
                                [소수점]
                                %자릿수.소수점자릿수f : 자릿수만(소수점포함)만큼 자릿수를 차지, 소수점자릿수까지 출력
        ...
        System.out.print("\n 줄바꿈 \t 들여쓰기 \" 큰따옴표 출력 \\ 백슬래시 출력 \'작은따옴표 출력 \n");
