...
public class Step3 {    // class s
    public static void main(String[] args) {        // main s
        ...
        // byte b3 = 200;           // 저장 가능한 허용 범위 벗어남


        // [2] short : -32,768 ~ 32,767, 대략 +-3만 정도
        short s1 = 32000;           System.out.println("s1 = " + s1);
        short s2 = -32000;          System.out.println("s2 = " + s2);
        // short s3 = 40000;        // 저장 가능한 허용 범위 벗어남


        // [3] int : 대략 +-21억 정도, 자바는 모든 정수 값을 기본으로 int
        int i1 = 2100000000;        System.out.println("i1 = " + i1);
        // int i2 = 3000000000;     // 저장 가능한 허용 범위 벗어남


        // [4] long : 대략 +-21억 이상, 21억 이상의 자료는 뒤에 L/l을 붙입니다.
        ...
        // 2. 문자 자료형
        // [5] char : 문자 1개만 저장 가능, '' 작은따옴표 사용 , 65,536개 문자 표현 가능.
        ...
        // [6] String 클래스, 기본 자료형[8]이 아닌 클래스를 사용하므로 첫글자 대문자 String
